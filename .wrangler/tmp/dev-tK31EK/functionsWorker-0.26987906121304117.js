...
// .wrangler/tmp/bundle-vszQeC/checked-fetch.js
...
// .wrangler/tmp/pages-7wi7wN/functionsWorker-0.26987906121304117.mjs
...
async function onRequestGet3(context) {
  ...
  const repo = context.env.GITHUB_REPO;
  const url = new URL(context.request.url);
  const path = url.searchParams.get("path") || "content/ullu";
  const apiUrl = `https://api.github.com/repos/${repo}/contents/${path}`;
  try {
    const ghResponse = await fetch(apiUrl, {
      headers: {
...
async function onRequestPost(context) {
  ...
  try {
    ...
    const ghResponse = await fetch(apiUrl, {
      method: "PUT",
      // GitHub uses PUT for creating/updating files
      headers: {
        "Authorization": token,
        "User-Agent": "Baingan-CMS",
        "Accept": "application/vnd.github.v3+json",
...
// .wrangler/tmp/bundle-vszQeC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vszQeC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.26987906121304117.js.map
